...
Ele acontece diariamente, em cada ponto de contato com o público:
...
·         O papel da gestão de marca

Na Filomena, trabalhamos a marca de forma integrada.

Não olhamos apenas para o que é comunicado, mas também para:
